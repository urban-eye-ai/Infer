...
# Model settings - using a pre-trained model from YOLOv5 instead of custom model
MODEL_NAME = "yolov5s"  # Using the small variant of YOLOv5
CONF_THRESHOLD = 0.25
IOU_THRESHOLD = 0.45
...
def load_model():
    ...
    global model
    if model is None:
        # Load directly from torch hub instead of a local file
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p class="lead">Upload an image to detect objects using YOLOv5 model</p>
            <div class="model-info">Using pre-trained YOLOv5s model from ultralytics/yolov5</div>
        </div>
